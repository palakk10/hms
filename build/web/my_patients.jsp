...
<%
    ...
    while(rsPatients.next()) {
        ...
        int roomNo = rsPatients.getInt("ROOM_NO");
        int bedNo = rsPatients.getInt("BED_NO");
        String roomType = rsPatients.getString("room_type");
        String roomStatus = rsPatients.getString("room_status");
        int roomCharges = rsPatients.getInt("room_charges");
...
%>          
                                    <tr class="expandable-row" onclick="toggleDetails(<%=patientId%>)">
                                        ...
                                        <td>
                                            <strong>Room:</strong> <%=(roomNo > 0 && bedNo > 0) ? roomNo + "/" + bedNo + " (" + roomType + ")" : "Not Assigned"%><br>
                                            <strong>Status:</strong> <%=roomStatus != null ? roomStatus : "N/A"%><br>
                                            <strong>Charges:</strong> <%=roomCharges > 0 ? roomCharges : "N/A"%>
                                        </td>
                                        <td>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <table class="table table-bordered patient-details-table">
                                                        ...
                                                        <tr>
                                                            <th>Room/Bed</th>
                                                            <td><%=(roomNo > 0 && bedNo > 0) ? roomNo + "/" + bedNo + " (" + roomType + ")" : "Not Assigned"%></td>
                                                        </tr>
                                                        <tr>
                                                            <th>Room Status</th>
                                                        ...
                                                        <tr>
                                                            <th>Room Charges</th>
                                                            <td><%=roomCharges > 0 ? roomCharges : "N/A"%></td>
                                                        </tr>
                                                        <tr>
...
<%
    // Re-fetch patients to create modals with a different variable name
    ...
    while(rsPatientsModal.next()) {
        ...
        int roomNo = rsPatientsModal.getInt("ROOM_NO");
        int bedNo = rsPatientsModal.getInt("BED_NO");
        String roomType = rsPatientsModal.getString("room_type");
        String roomStatus = rsPatientsModal.getString("room_status");
        int roomCharges = rsPatientsModal.getInt("room_charges");
...
<%
        ...
        if(rsBilling.next()) {
            ...
            int miscCharge = rsBilling.getInt("MISC");
...
%>
                                                            <tr>
                                                                ...
                                                                <td><%=miscCharge > 0 ? miscCharge : "N/A"%></td>
                                                                <td><%=entryDate%></td>
                                                                <td><%=dischargeDate%></td>
                                                            </tr>
<%
...
%>
                                                            <tr>
                                                                <td colspan="6" class="text-center">No billing information available</td>
                                                            </tr>
<%
        }
        rsBilling.close();
...
<%
        // Re-fetch prescriptions to create edit modals
        PreparedStatement psPresc = c.prepareStatement(
